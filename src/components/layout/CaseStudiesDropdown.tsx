    ...
    >
      ...
      {caseStudyLinks.map((item) => (
        <NavLink
          key={item.id}
          to={item.to}
          className="inline-flex w-full whitespace-nowrap px-4 py-2 text-sm font-medium text-slate-900 transition-all duration-200 hover:-translate-y-px hover:text-slate-950 dark:text-slate-100 dark:hover:text-white"
